...
//
//	lista = inserareInceput(creareAeroport("Otopeni", 300), lista);
//	lista = inserareInceput(creareAeroport("Baneasa", 30), lista);
//	lista = inserareInceput(creareAeroport("Kogalniceanu", 150), lista);
//
