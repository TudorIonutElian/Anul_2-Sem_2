...
public class Game  {
    ...
    private ArrayList map; // the map - an ArrayList of Rooms    
     ...
     */
    public Game() {
        this.map = new ArrayList(); // TODO: Make map a Generic list of Room
        ...
        player = new Actor("player", "a loveable game-player", (Room) map.get(0));
    }
