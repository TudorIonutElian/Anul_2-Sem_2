...
import myclasses.NoisyThing;
import myclasses.Thing;
...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        outputTA.setText("You have a " + mySword.getName() + " which is "
                + mySword.getDescription() + "\nand an "
                + myRing.getName() + " which is "
                + myRing.getDescription()
                + "\nYou also have two noisy things... \n"
                + myCat.getName() + " which is "
                + myCat.getDescription() + " which goes "
                + myCat.getNoise() + " with a volume of "
                + myCat.getVolume() + "\nand also "
                + myDog.getName() + " which is "
                + myDog.getDescription() + " which goes "
                + myDog.getNoise() + " with a volume of "
                + myDog.getVolume() );
