...
public class angajat {
	...
	// constructor folosit pentru a initializa cu valori default
	public angajat() {
		this.dataAngajare = null;
		this.nume = null;
	}
	
	//will allow someone who uses the class to enter in values for "nume"
	...
	//overloading -> using 2 or more methods with the same method name
	...
	public static void main(String[] args) {
		...
		//inchid explicit reader ca sa nu mai imi dea warning
		finally 
		{
		reader.close();
		}
